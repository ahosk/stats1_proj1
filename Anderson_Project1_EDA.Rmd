...
write.csv(train_df, "./training_dataset.csv", row.names=FALSE)
write.csv(val_df, "./validation_dataset.csv", row.names=FALSE)
write.csv(test_df, "./testing_dataset.csv", row.names=FALSE)
