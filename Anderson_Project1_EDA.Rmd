...
write.csv(train_df, "./training_dataset_0206_2.csv", row.names=FALSE)
write.csv(val_df, "./validation_dataset_0206_2.csv", row.names=FALSE)
write.csv(test_df, "./testing_dataset_0206_2.csv", row.names=FALSE)
